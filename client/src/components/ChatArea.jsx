  ...
  return (
    <>
      <div className="flex-1 min-w-0 flex flex-col relative overflow-hidden bg-[#071018] text-white h-[100dvh] md:h-screen">
        ...
        <div className="w-full h-[92px] md:h-[85px] pt-12 md:pt-0 shrink-0 border-b border-white/5 bg-[#0e1621] flex items-center justify-between px-4 md:px-6 relative z-20 shadow-md select-none">
